...
<div class="col-md-10">
<a href="mailto:jayaraj.veluchamy@gmail.com" style="color:#000000">jayaraj.veluchamy@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
    <img src="image/JJ_PIC.jpg" width=100 height=120 alt="JJ" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<h4 style="font-family:'typo' ">JAYARAJ V</h4>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8098573854</h4>
		<a href="mailto:https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox" title="Mail Me"><h4 style="font-family:'typo' " targt="blank">jayaraj.veluchamy@gmail.com</h4></a>
		<h4 style="font-family:'typo' ">V.S.B. Engineering College, Karur</h4></div></div>
		</p>
      </div>
